...
c++ -Wall -Wextra -Werror -std=c++98 ./main_clear_o.cpp && valgrind --leak-check=full --show-leak-kinds=all ./a.out > ./txts/clear_o.txt
c++ -Wall -Wextra -Werror -std=c++98 ./main_clear_ft.cpp && ./a.out > ./txts/clear_ft.txt
