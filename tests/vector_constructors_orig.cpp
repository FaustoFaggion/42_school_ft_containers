...
int	main(void) {
	...
	std::vector<int> int_vector(4, 44);
	std::vector<float> float_vector(4, 44.1);
	std::vector<std::string> string_vector(4, "Ana");
	...
	std::vector<int> int_vector2(int_vector.begin(), int_vector.begin() + 2);
	std::vector<float> float_vector2(float_vector.begin(), float_vector.begin() + 2);
	std::vector<std::string> string_vector2(string_vector.begin(), string_vector.begin() + 2);
	...
	for (std::vector<float>::iterator it = float_vector2.begin(); it != float_vector2.end(); it++) {
		std::cout << *it << std::endl;
	}
	std::cout<< "<float> size: " << float_vector2.size() << " max_size: " << float_vector2.max_size() << " capacity: " << float_vector2.capacity() << " empty: " << float_vector2.empty() << std::endl;
	
	for (std::vector<std::string>::iterator it = string_vector2.begin(); it != string_vector2.end(); it++) {
		std::cout << *it << std::endl;
	}
	std::cout<< "<string> size: " << string_vector2.size() << " max_size: " << string_vector2.max_size() << " capacity: " << string_vector2.capacity() << " empty: " << string_vector2.empty() << std::endl;
	...
	std::vector<int> int_vector3(int_vector);
	std::vector<float> float_vector3(float_vector);
	std::vector<std::string> string_vector3(string_vector);
	...
	for (std::vector<int>::iterator it_ = int_vector3.begin(); it_ != int_vector3.end(); it_++) {
		std::cout << *it_ << std::endl;
	}
	std::cout<< "<int> size: " << int_vector3.size() << " max_size: " << int_vector3.max_size() << " capacity: " << int_vector3.capacity() << " empty: " << int_vector3.empty() << std::endl;

	for (std::vector<float>::iterator it = float_vector3.begin(); it != float_vector3.end(); it++) {
		std::cout << *it << std::endl;
	}
	std::cout<< "<float> size: " << float_vector3.size() << " max_size: " << float_vector3.max_size() << " capacity: " << float_vector3.capacity() << " empty: " << float_vector3.empty() << std::endl;
	
	for (std::vector<std::string>::iterator it = string_vector3.begin(); it != string_vector3.end(); it++) {
		std::cout << *it << std::endl;
	}
	std::cout<< "<string> size: " << string_vector3.size() << " max_size: " << string_vector3.max_size() << " capacity: " << string_vector3.capacity() << " empty: " << string_vector3.empty() << std::endl;
	...
	std::vector<ClassTest> class_vector(4, a);
	...
	std::vector<ClassTest> class_range(4, b);

	std::vector<ClassTest> class_vector2(class_range.begin(), class_range.begin() + 2);
	for (std::vector<ClassTest>::iterator it = class_vector2.begin(); it != class_vector2.end(); it++) {
		std::cout << *it << std::endl;
	}
	...
	std::vector<ClassTest> class_vector3(class_vector);
	...
	for (std::vector<ClassTest>::iterator it = class_vector3.begin(); it != class_vector3.end(); it++) {
		std::cout << *it << std::endl;
	}
	std::cout<< "<class> size: " << class_vector3.size() << " max_size: " << class_vector3.max_size() << " capacity: " << class_vector3.capacity() << " empty: " << class_vector3.empty() << std::endl;
