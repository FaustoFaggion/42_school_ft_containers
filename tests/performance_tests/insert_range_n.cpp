...
{
	std::cout << "INSERT RANGE N" << std::endl;
	...
	for (int i = 0; i < 10; i++) {
		t1_std = std::clock();
		str_std0.insert(str_std0.begin() + 2, 100, "b");
	...
	for (int i = 0; i < 10; i++) {
		t2_ft = std::clock();
		str_ft0.insert(str_ft0.begin() + 2, 100, "b");
	...
	for (int i = 0; i < 10; i++) {
		t3_std = std::clock();
		int_std0.insert(int_std0.begin() + 2, 100, 7);
	...
	for (int i = 0; i < 10; i++) {
		t4_ft = std::clock();
		int_ft0.insert(int_ft0.begin() + 2, 100, 7);;
