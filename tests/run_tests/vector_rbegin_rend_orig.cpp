...
int	main(void) {
	...
	std::cout << "\n------end------\n" << std::endl;
	for(std::vector<int>::reverse_iterator it = int_vector.rbegin(); it != int_vector.rend(); it++) {
		std::cout << *it << std::endl;
	}

	std::cout << "----" << std::endl;
	for(std::vector<float>::reverse_iterator it = float_vector.rbegin(); it != float_vector.rend(); it++) {
		std::cout << *it << std::endl;
	}
	
	std::cout << "----" << std::endl;
	for(std::vector<std::string>::reverse_iterator it = string_vector.rbegin(); it != string_vector.rend(); it++) {
		std::cout << *it << std::endl;
	}
	std::cout << "----" << std::endl;
	for(std::vector<ClassTest>::reverse_iterator it = class_vector.rbegin(); it != class_vector.rend(); it++) {
		std::cout << *it << std::endl;
	}
	return (0);
}
