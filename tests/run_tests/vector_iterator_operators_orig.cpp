...

{
	...
	std::vector<int>::iterator it1 = int_vector.begin();
	std::vector<int>::iterator it2 = int_vector.begin();
...

{
	...
	std::cout << "****" << std::endl;
	std::cout << "it1 = it2" << std::endl;
	std::vector<float>::iterator it1 = float_vector.begin();
	std::vector<float>::iterator it2 = float_vector.begin();
	std::cout << "it1: " << *it1 << " - it2: " << *it2 << std::endl;
	std::cout << "it1 = it2: " << (it1 == it2) << std::endl;
	std::cout << "it1 != it2: " << (it1 != it2) << std::endl;
	std::cout << "it1 >= it2: " << (it1 >= it2) << std::endl;
...

{
	...
	std::cout << "****" << std::endl;
	std::cout << "it1 = it2" << std::endl;
	std::vector<std::string>::iterator it1 = string_vector.begin();
	std::vector<std::string>::iterator it2 = string_vector.begin();
	std::cout << "it1: " << *it1 << " - it2: " << *it2 << std::endl;
	std::cout << "it1 = it2: " << (it1 == it2) << std::endl;
	std::cout << "it1 != it2: " << (it1 != it2) << std::endl;
	std::cout << "it1 >= it2: " << (it1 >= it2) << std::endl;
...

{
	...
	std::cout << "****" << std::endl;
	std::cout << "it1 = it2" << std::endl;
	std::vector<ClassTest>::iterator it1 = class_vector.begin();
	std::vector<ClassTest>::iterator it2 = class_vector.begin();
	std::cout << "it1: " << *it1 << " - it2: " << *it2 << std::endl;
	std::cout << "it1 = it2: " << (it1 == it2) << std::endl;
	std::cout << "it1 != it2: " << (it1 != it2) << std::endl;
	std::cout << "it1 >= it2: " << (it1 >= it2) << std::endl;
